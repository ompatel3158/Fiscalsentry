...
var session_stores_exports = {};
__export(session_stores_exports, {
  FileSessionStore: () => FileSessionStore,
  InMemorySessionStore: () => InMemorySessionStore
});
module.exports = __toCommonJS(session_stores_exports);
...
function normalizeGetSnapshotOptions(opts) {
  ...
  if (sessionId) {
    (0, import_session.assertValidSessionId)(sessionId);
  }
