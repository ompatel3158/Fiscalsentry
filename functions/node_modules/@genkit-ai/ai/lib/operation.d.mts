import { BackgroundActionRunOptions } from '@genkit-ai/core';
 ...
 */
declare const OPERATION_CONFIG_CONTEXT_KEY = "config";
/**
 ...
 */
interface OperationOptions extends BackgroundActionRunOptions {
    /**
 ...
 */
declare function toRunOptions(options?: OperationOptions): BackgroundActionRunOptions | undefined;

export { OPERATION_CONFIG_CONTEXT_KEY, type OperationOptions, toRunOptions };
