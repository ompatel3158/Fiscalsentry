...
import { SessionState, Artifact, SessionSnapshot } from './agent-types.js';
export { AgentFinishReason, AgentFinishReasonSchema, ArtifactSchema, SessionSnapshotSchema, SessionStateSchema } from './agent-types.js';
 ...
 */
type SessionSnapshotInput<S = unknown> = Omit<SessionSnapshot<S>, 'snapshotId'> & {
    snapshotId?: string;
};
/**
 ...
 */
type SnapshotMutator<S = unknown> = (current: SessionSnapshot<S> | undefined) => SessionSnapshotInput<S> | null;
/**
 ...
 */
declare class Session<S = unknown> extends EventEmitter {
    private state;
    private version;
     ...
     */
    updateCustom(fn: (custom?: S) => S): void;
    /**
 ...
 */
declare function assertValidSessionId(sessionId: string): void;
/**
 ...
 */
declare function reserveSnapshotId(): string;

export { Artifact, type GetSnapshotOptions, Session, SessionError, SessionSnapshot, type SessionSnapshotInput, SessionState, type SessionStore, type SessionStoreOptions, type SnapshotMutator, assertValidSessionId, getCurrentSession, reserveSnapshotId, runWithSession };
