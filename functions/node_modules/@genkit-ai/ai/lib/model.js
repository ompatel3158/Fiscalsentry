...
__export(model_exports, {
  ...
  MultipartToolResponseSchema: () => import_parts.MultipartToolResponseSchema,
  ReasoningPartSchema: () => import_parts.ReasoningPartSchema,
  ResourcePartSchema: () => import_parts.ResourcePartSchema,
...
function backgroundModel(options) {
  ...
  const act = (0, import_core.backgroundAction)({
    ...
    cancel: options.cancel ? async (op, opts) => {
      if (!options.cancel) {
...
const ModelReferenceSchema = import_core.z.object({
