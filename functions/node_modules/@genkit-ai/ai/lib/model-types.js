...
const MiddlewareRefSchema = import_core.z.object({
...
const ToolDefinitionSchema = import_core.z.object({
  name: import_core.z.string(),
  key: import_core.z.string().optional(),
...
const GenerateActionOptionsSchema = import_core.z.object({
  ...
  use: import_core.z.array(MiddlewareRefSchema).optional()
});
