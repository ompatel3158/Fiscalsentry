 ...
 */
declare const GENKIT_UI_METADATA: {
    /**
     ...
     * }
     */
    readonly DATA_SOURCE: "x-genkit-ui-data-source";
    /**
     ...
     */
    readonly DISPLAY_NAME: "x-genkit-ui-display-name";
    /**
     ...
     */
    readonly WIDGET: "x-genkit-ui-widget";
};
/**
 * Standard UI widget names used with GENKIT_UI_METADATA.WIDGET.
 */
declare const GENKIT_UI_WIDGETS: {
    /** A widget for configuring a list of models. */
    readonly MODEL_LIST: "model-list-config";
    /** A widget for configuring LLM model safety settings. */
    readonly SAFETY_SETTINGS: "safety-settings";
};

export { GENKIT_UI_METADATA, GENKIT_UI_WIDGETS };
