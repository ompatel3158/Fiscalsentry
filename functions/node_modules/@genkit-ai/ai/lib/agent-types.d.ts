 ...
 */
declare const SnapshotStatusSchema: z.ZodEnum<["pending", "completed", "aborted", "failed", "expired"]>;
/**
 * Lifecycle status of a session snapshot.
 */
type SnapshotStatus = z.infer<typeof SnapshotStatusSchema>;
/**
 ...
 */
declare const AgentFinishReasonSchema: z.ZodEnum<["stop", "length", "blocked", "interrupted", "other", "unknown", "aborted", "detached", "failed"]>;
/**
 * Reason an agent turn (or whole invocation) finished.
 */
type AgentFinishReason = z.infer<typeof AgentFinishReasonSchema>;
/**
 ...
 */
interface SessionState<S = unknown> {
    sessionId?: string;
 ...
 */
declare const AgentInitSchema: z.ZodObject<{
...
declare const AgentResultSchema: z.ZodObject<{
    ...
    finishReason: z.ZodOptional<z.ZodEnum<["stop", "length", "blocked", "interrupted", "other", "unknown", "aborted", "detached", "failed"]>>;
}, "strip", z.ZodTypeAny, {
    message?: {
        content: ({
            text: string;
    ...
    finishReason?: "aborted" | "length" | "unknown" | "stop" | "blocked" | "interrupted" | "other" | "failed" | "detached" | undefined;
    artifacts?: {
        parts: ({
            text: string;
            custom?: Record<string, unknown> | undefined;
 ...
 */
declare const AgentOutputSchema: z.ZodObject<{
    /**
 ...
 */
declare const TurnEndSchema: z.ZodObject<{
    snapshotId: z.ZodOptional<z.ZodString>;
 ...
 */
type TurnEnd = z.infer<typeof TurnEndSchema>;
/**
 * Schema for the operation kind of a JSON Patch operation (RFC 6902).
 */
declare const JsonPatchOpSchema: z.ZodEnum<["add", "remove", "replace", "move", "copy", "test"]>;
/**
 * Operation kind of a JSON Patch (RFC 6902) operation.
 */
type JsonPatchOp = z.infer<typeof JsonPatchOpSchema>;
/**
 * Schema for a single RFC 6902 (JSON Patch) operation.
 */
declare const JsonPatchOperationSchema: z.ZodObject<{
 ...
 */
declare const JsonPatchSchema: z.ZodArray<z.ZodObject<{
    op: z.ZodEnum<["add", "remove", "replace", "move", "copy", "test"]>;
    /** A JSON Pointer (RFC 6901) to the target location, e.g. `"/agentStatus"`. */
    path: z.ZodString;
    /** Source pointer; required for `move` and `copy`. */
 ...
 */
declare const AgentStreamChunkSchema: z.ZodObject<{
    modelChunk: z.ZodOptional<z.ZodObject<{
     ...
     */
    customPatch: z.ZodOptional<z.ZodArray<z.ZodObject<{
        op: z.ZodEnum<["add", "remove", "replace", "move", "copy", "test"]>;
        /** A JSON Pointer (RFC 6901) to the target location, e.g. `"/agentStatus"`. */
        path: z.ZodString;
        /** Source pointer; required for `move` and `copy`. */
    ...
    turnEnd: z.ZodOptional<z.ZodObject<{
        snapshotId: z.ZodOptional<z.ZodString>;
        /** The reason this turn finished (e.g. `stop`, `interrupted`). */
        finishReason: z.ZodOptional<z.ZodEnum<["stop", "length", "blocked", "interrupted", "other", "unknown", "aborted", "detached", "failed"]>>;
    }, "strip", z.ZodTypeAny, {
 ...
 */
type AgentStreamChunk = z.infer<typeof AgentStreamChunkSchema>;
/**
 ...
 */
declare const SessionSnapshotSchema: z.ZodObject<{
    snapshotId: z.ZodString;
    sessionId: z.ZodOptional<z.ZodString>;
    parentId: z.ZodOptional<z.ZodString>;
    createdAt: z.ZodString;
    updatedAt: z.ZodOptional<z.ZodString>;
    heartbeatAt: z.ZodOptional<z.ZodString>;
    status: z.ZodOptional<z.ZodEnum<["pending", "completed", "aborted", "failed", "expired"]>>;
    finishReason: z.ZodOptional<z.ZodEnum<["stop", "length", "blocked", "interrupted", "other", "unknown", "aborted", "detached", "failed"]>>;
    error: z.ZodOptional<z.ZodObject<{
        /** Canonical status name (e.g. `INTERNAL`, `FAILED_PRECONDITION`). */
        status: z.ZodOptional<z.ZodString>;
    ...
    snapshotId: string;
    createdAt: string;
    status?: "aborted" | "pending" | "completed" | "failed" | "expired" | undefined;
    finishReason?: "aborted" | "length" | "unknown" | "stop" | "blocked" | "interrupted" | "other" | "failed" | "detached" | undefined;
    sessionId?: string | undefined;
    state?: {
        custom?: any;
 ...
 */
declare const GetSnapshotRequestSchema: z.ZodObject<{
    snapshotId: z.ZodOptional<z.ZodString>;
    sessionId: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    sessionId?: string | undefined;
 ...
 */
type GetSnapshotRequest = z.infer<typeof GetSnapshotRequestSchema>;
/**
 * Schema for the input of the `abort` companion action.
 */
declare const AgentAbortRequestSchema: z.ZodObject<{
    snapshotId: z.ZodString;
}, "strip", z.ZodTypeAny, {
    snapshotId: string;
}, {
 ...
 */
type AgentAbortRequest = z.infer<typeof AgentAbortRequestSchema>;
/**
 * Schema for the output of the `abort` companion action.
 */
declare const AgentAbortResponseSchema: z.ZodObject<{
    snapshotId: z.ZodString;
    status: z.ZodOptional<z.ZodEnum<["pending", "completed", "aborted", "failed", "expired"]>>;
}, "strip", z.ZodTypeAny, {
    snapshotId: string;
 ...
 */
type AgentAbortResponse = z.infer<typeof AgentAbortResponseSchema>;
/**
 ...
 *   output payloads.
 */
declare const AgentStateManagementSchema: z.ZodEnum<["server", "client"]>;
/**
 * Who owns session state for an agent.
 */
type AgentStateManagement = z.infer<typeof AgentStateManagementSchema>;
/**
...
declare const AgentMetadataSchema: z.ZodObject<{
     ...
     */
    stateSchema: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
}, "strip", z.ZodTypeAny, {
    stateManagement: "server" | "client";
    abortable: boolean;
    stateSchema?: Record<string, any> | undefined;
}, {
    stateManagement: "server" | "client";
    abortable: boolean;
    stateSchema?: Record<string, any> | undefined;
...
export { type AgentAbortRequest, AgentAbortRequestSchema, type AgentAbortResponse, AgentAbortResponseSchema, type AgentFinishReason, AgentFinishReasonSchema, type AgentInit, AgentInitSchema, type AgentInput, AgentInputSchema, type AgentMetadata, AgentMetadataSchema, type AgentOutput, AgentOutputSchema, type AgentResult, AgentResultSchema, type AgentStateManagement, AgentStateManagementSchema, type AgentStreamChunk, AgentStreamChunkSchema, type Artifact, ArtifactSchema, type GetSnapshotRequest, GetSnapshotRequestSchema, type JsonPatchOp, JsonPatchOpSchema, JsonPatchOperationSchema, JsonPatchSchema, type RuntimeError, RuntimeErrorSchema, type SessionSnapshot, SessionSnapshotSchema, type SessionState, SessionStateSchema, type SnapshotStatus, SnapshotStatusSchema, type TurnEnd, TurnEndSchema };
