import { z, Operation, ActionContext, ResolvableAction, ActionMetadata, Action, ActionRunOptions, JSONSchema7, ActionFnArg, StatusName, StreamingCallback, SimpleMiddleware, MiddlewareWithOptions, BackgroundAction, BackgroundActionFnArg, GenkitError } from '@genkit-ai/core';
import { Registry, ActionType, HasRegistry } from '@genkit-ai/core/registry';
import Handlebars from 'handlebars';
import { e as EmbedderParams, g as Embedding, c as EmbedderArgument, a as DocumentData, k as EmbeddingBatch, D as Document } from './document-B4idvsqH.mjs';
import { GenerateResponseChunk } from './generate/chunk.mjs';
import { GenerationCommonConfigSchema, ToolDefinition, MiddlewareRef, GenerateActionOptions, GenerateResponseChunkData, GenerateResponseData, GenerateRequest, ModelInfo, GenerateActionOptionsSchema, GenerateResponseSchema, GenerateResponseChunkSchema, Role, GenerateActionOutputConfig, GenerateRequestSchema, MessageData, CandidateData, GenerationUsage } from './model-types.mjs';
import { OperationOptions } from './operation.mjs';
import { Session } from './session.mjs';
import { GenerateResponse } from './generate/response.mjs';
import { Part, ToolRequestPart, ToolResponsePart, MultipartToolResponseSchema, MediaPart } from './parts.mjs';
...
declare class GenkitAI {
     ...
     * ```
     */
    generateStream<O extends z.ZodTypeAny = z.ZodTypeAny, CustomOptions extends z.ZodTypeAny = typeof GenerationCommonConfigSchema>(opts: GenerateStreamOptions<O, CustomOptions> | PromiseLike<GenerateStreamOptions<O, CustomOptions>>): GenerateStreamResponse<z.infer<O>>;
    /**
     ...
     * @returns
     */
    checkOperation<T>(operation: Operation<T>, options?: OperationOptions): Promise<Operation<T>>;
    /**
     ...
     * @returns
     */
    cancelOperation<T>(operation: Operation<T>, options?: OperationOptions): Promise<Operation<T>>;
    /**
 ...
 * @beta
 */
declare function restartTool(interrupt: ToolRequestPart, resumedMetadata?: any, options?: {
    /**
 ...
 * @beta
 */
declare function respondTool(interrupt: ToolRequestPart, responseData: any, options?: {
    metadata?: any;
}): ToolResponsePart;
...
declare function isMultipartTool(t: unknown): t is MultipartToolAction;
...
declare const MiddlewareDescSchema: z.ZodObject<{
    ...
    configSchema: z.ZodOptional<z.ZodNullable<z.ZodRecord<z.ZodString, z.ZodAny>>>;
...
/** Descriptor for a registered middleware, returned by reflection API. */
type MiddlewareDesc = z.infer<typeof MiddlewareDescSchema>;
/**
 ...
 */
interface GenerateMiddleware<ConfigSchema extends z.ZodTypeAny = z.ZodTypeAny, PluginOptions = void> extends MiddlewareDesc {
    /** Configures the middleware, returning a MiddlewareRef for usage in `generate({use: [...]})`. */
    (config?: z.infer<ConfigSchema>): MiddlewareRef & {
        __def: GenerateMiddleware<ConfigSchema, PluginOptions>;
    };
     ...
     */
    instantiate: (options: MiddlewareFnOptions<ConfigSchema, PluginOptions>) => GenerateMiddlewareDef;
    /**
...
interface GenerateMiddlewareDef {
    ...
    generate?: (envelope: {
        ...
        currentTurn: number;
        messageIndex: number;
    }, ctx: ActionRunOptions<GenerateResponseChunkData>, next: (envelope: {
        request: GenerateActionOptions;
        currentTurn: number;
        messageIndex: number;
    }, ctx: ActionRunOptions<GenerateResponseChunkData>) => Promise<GenerateResponseData>) => Promise<GenerateResponseData>;
    /**
     * Hook for intercepting the underlying model execution.
     * Ideal for model-level caching, retry logic, or prompt/response parsing.
     */
    model?: (req: GenerateRequest<any>, ctx: ActionRunOptions<GenerateResponseChunkData>, next: (req: GenerateRequest<any>, ctx: ActionRunOptions<GenerateResponseChunkData>) => Promise<GenerateResponseData>) => Promise<GenerateResponseData>;
    /**
     * Hook for intercepting individual tool calls.
     * Enables caching tool responses, validating inputs, or overriding tool execution.
     */
    tool?: (req: ToolRequestPart, ctx: ActionRunOptions<any>, next: (req: ToolRequestPart, ctx: ActionRunOptions<any>) => Promise<ToolResponsePart | undefined>) => Promise<ToolResponsePart | undefined>;
    /**
 ...
 */
interface MiddlewareFnOptions<ConfigSchema extends z.ZodTypeAny = z.ZodTypeAny, PluginOptions = void> {
    config: z.infer<ConfigSchema> | undefined;
    pluginConfig: PluginOptions;
    ai: GenkitAI;
}
declare function generateMiddleware<PluginOptions = void, ConfigSchema extends z.ZodTypeAny = z.ZodTypeAny>(options: {
    name: string;
    configSchema?: ConfigSchema;
    description?: string;
    metadata?: Record<string, any>;
}, middlewareFn: (options: MiddlewareFnOptions<ConfigSchema, PluginOptions>) => GenerateMiddlewareDef): GenerateMiddleware<ConfigSchema, PluginOptions>;
declare function resolveMiddleware(registry: Registry, refs?: MiddlewareRef[]): Promise<GenerateMiddlewareDef[]>;
...
type DefineBackgroundModelOptions<CustomOptionsSchema extends z.ZodTypeAny = z.ZodTypeAny> = DefineModelOptions<CustomOptionsSchema> & {
    start: (request: GenerateRequest<CustomOptionsSchema>, options?: BackgroundActionFnArg<unknown>) => Promise<Operation<GenerateResponseData>>;
    check: (operation: Operation<GenerateResponseData>, options?: BackgroundActionFnArg<unknown>) => Promise<Operation<GenerateResponseData>>;
    cancel?: (operation: Operation<GenerateResponseData>, options?: BackgroundActionFnArg<unknown>) => Promise<Operation<GenerateResponseData>>;
};
/**
...
declare const ModelReferenceSchema: z.ZodObject<{
    name: z.ZodString;
 ...
 */
interface ModelReference<CustomOptions extends z.ZodTypeAny> extends z.infer<typeof ModelReferenceSchema> {
    name: string;
 ...
 */
declare function normalizeMiddleware(registry: Registry, middlewareList?: (ModelMiddlewareArgument | GenerateMiddleware | MiddlewareRef)[]): Promise<MiddlewareRef[]>;
/**
 * Generate calls a generative model based on the provided prompt and configuration. If
...
declare function maybeRegisterDynamicMiddlewareTools(registry: Registry, middlewares?: GenerateMiddlewareDef[]): void;
...
export { dynamicTool as $, generateMiddleware as A, generateOperation as B, generateStream as C, interrupt as D, type ExecutablePrompt as E, isExecutablePrompt as F, type GenerateMiddleware as G, loadPromptFolder as H, type InterruptConfig as I, modelActionMetadata as J, modelRef as K, prompt as L, type MiddlewareDesc as M, respondTool as N, type OutputOptions as O, type PromptAction as P, restartTool as Q, type ResumeOptions as R, toGenerateRequest as S, type ToolAction as T, type ModelAction as U, type ToolRunOptions as V, type DynamicToolAction as W, type MultipartToolFn as X, type Resumable as Y, type ToolFn as Z, type ToolFnOptions as _, type GenerateMiddlewareDef as a, isDynamicTool as a0, isMultipartTool as a1, isToolRequest as a2, isToolResponse as a3, lookupToolByName as a4, resolveTools as a5, toToolDefinition as a6, tool as a7, type MiddlewareFnOptions as a8, resolveMiddleware as a9, defineBackgroundModel as aA, defineModel as aB, getBasicUsageStats as aC, model as aD, resolveModel as aE, maybeRegisterDynamicMiddlewareTools as aF, normalizeMiddleware as aG, toGenerateActionOptions as aH, type DocsResolver as aI, type ExecutablePromptAction as aJ, type MessagesResolver as aK, type PartsResolver as aL, isPromptAction as aM, loadPromptFolderRecursively as aN, type AugmentWithContextOptions as aa, CONTEXT_PREFACE as ab, type FallbackOptions as ac, type RetryOptions as ad, type SimulatedConstrainedGenerationOptions as ae, TEST_ONLY as af, augmentWithContext as ag, downloadRequestMedia as ah, fallback as ai, retry as aj, simulateConstrainedGeneration as ak, simulateSystemPrompt as al, validateSupport as am, type GenerateAction as an, defineGenerateAction as ao, generateHelper as ap, inferRoleFromParts as aq, shouldInjectFormatInstructions as ar, type BackgroundModelAction as as, type DefineBackgroundModelOptions as at, type DefineModelOptions as au, type ModelMiddleware as av, type ModelMiddlewareArgument as aw, type ModelMiddlewareWithOptions as ax, type ResolvedModel as ay, backgroundModel as az, type GenerateOptions as b, type GenerateStreamOptions as c, type GenerateStreamResponse as d, GenerationBlockedError as e, GenerationResponseError as f, GenkitAI as g, type GenkitPluginV2 as h, MiddlewareDescSchema as i, type ModelArgument as j, type ModelReference as k, ModelReferenceSchema as l, type MultipartToolAction as m, type PromptConfig as n, type PromptGenerateOptions as o, type ToolArgument as p, type ToolChoice as q, type ToolConfig as r, ToolInterruptError as s, asTool as t, defineHelper as u, defineInterrupt as v, definePartial as w, definePrompt as x, defineTool as y, generate as z };
