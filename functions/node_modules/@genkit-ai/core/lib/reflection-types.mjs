...
const ReflectionRegisterParamsSchema = z.object({
  id: z.string(),
  pid: z.number(),
...
const ReflectionStreamChunkParamsSchema = z.object({
  requestId: z.string(),
  chunk: z.any()
});
const ReflectionRunActionStateParamsSchema = z.object({
  requestId: z.string(),
  state: z.object({
    traceId: z.string().optional()
  }).optional()
});
const ReflectionConfigureParamsSchema = z.object({
  telemetryServerUrl: z.string().optional()
});
const ReflectionListValuesParamsSchema = z.object({
  type: z.string()
});
const ReflectionRunActionParamsSchema = z.object({
  key: z.string(),
...
const ReflectionCancelActionParamsSchema = z.object({
  traceId: z.string()
});
const ReflectionSendInputStreamChunkParamsSchema = z.object({
  requestId: z.string(),
  chunk: z.any()
});
const ReflectionEndInputStreamParamsSchema = z.object({
  requestId: z.string()
});
const ReflectionListActionsResponseSchema = z.object({
  actions: z.record(z.string(), ActionMetadataSchema)
});
const ReflectionListValuesResponseSchema = z.object({
  values: z.record(z.any())
});
const ReflectionCancelActionResponseSchema = z.object({
  message: z.string()
});
export {
...
//# sourceMappingURL=reflection-types.mjs.map