import { z } from 'zod';
import { A as Action, g as ActionRunOptions, b as ActionFnArg, a9 as Registry } from './action-DlkZMCP7.js';
 ...
 */
interface Flow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny, S extends z.ZodTypeAny = z.ZodTypeAny, Init extends z.ZodTypeAny = z.ZodTypeAny> extends Action<I, O, S, ActionRunOptions<z.infer<S>, z.infer<I>>, Init> {
}
/**
 * Configuration for a streaming flow.
 */
interface FlowConfig<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny, S extends z.ZodTypeAny = z.ZodTypeAny, Init extends z.ZodTypeAny = z.ZodTypeAny> {
    /** Name of the flow. */
    name: string;
 ...
 */
declare function flow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny, S extends z.ZodTypeAny = z.ZodTypeAny, Init extends z.ZodTypeAny = z.ZodTypeAny>(config: FlowConfig<I, O, S, Init> | string, fn: FlowFn<I, O, S>): Flow<I, O, S, Init>;
/**
 * Defines a non-streaming flow. This operates on the currently active registry.
 */
declare function defineFlow<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny, S extends z.ZodTypeAny = z.ZodTypeAny, Init extends z.ZodTypeAny = z.ZodTypeAny>(registry: Registry, config: FlowConfig<I, O, S, Init> | string, fn: FlowFn<I, O, S>): Flow<I, O, S, Init>;
/**
