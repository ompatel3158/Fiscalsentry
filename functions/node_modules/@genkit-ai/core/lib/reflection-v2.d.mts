import { a9 as Registry } from './action-Djx4Avnp.mjs';
import 'json-schema';
import 'zod';
import './context.mjs';
...
interface ReflectionServerV2Options {
    configuredEnvs?: string[];
    name?: string;
    url: string;
}
declare class ReflectionServerV2 {
    private registry;
    private options;
    private ws;
    private url;
    ...
    private handleEndInputStream;
}

export { ReflectionServerV2, type ReflectionServerV2Options };
