...
interface BackgroundAction<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny, RunOptions extends BackgroundActionRunOptions = BackgroundActionRunOptions> {
    ...
    check(operation: Operation<z.infer<O>>, options?: RunOptions): Promise<Operation<z.infer<O>>>;
    cancel(operation: Operation<z.infer<O>>, options?: RunOptions): Promise<Operation<z.infer<O>>>;
}
...
type BackgroundActionParams<I extends z.ZodTypeAny, O extends z.ZodTypeAny, S extends z.ZodTypeAny = z.ZodTypeAny> = {
    ...
    check: (input: Operation<z.infer<O>>, options: BackgroundActionFnArg<z.infer<S>>) => Promise<Operation<z.infer<O>>>;
    cancel?: (input: Operation<z.infer<O>>, options: BackgroundActionFnArg<z.infer<S>>) => Promise<Operation<z.infer<O>>>;
