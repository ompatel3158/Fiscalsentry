...
import { a7 as ActionType, A as Action, c as ActionMetadata, d as ActionMetadataSchema, a8 as ActionMetadataRecord, a9 as Registry } from './action-Djx4Avnp.mjs';
import 'json-schema';
import './context.mjs';
...
declare class SimpleCache {
    ...
    setDap(dap: DynamicActionProviderAction): void;
    setValue(value: DapValue): void;
    /**
...
type DynamicActionProviderAction = Action<z.ZodVoid, z.ZodArray<typeof ActionMetadataSchema>, z.ZodTypeAny> & DynamicRegistry & {
    __action: {
        metadata: {
