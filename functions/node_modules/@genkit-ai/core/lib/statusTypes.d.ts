...
declare function statusNameToCode(status?: string | StatusName): StatusCodes | undefined;
...
export { type Status, StatusCodes, type StatusName, StatusNameSchema, StatusSchema, httpStatusCode, statusNameToCode };
