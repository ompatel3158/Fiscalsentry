...
class LoggingWinston extends TransportStream {
    static LOGGING_TRACE_KEY = common_1.LOGGING_TRACE_KEY;
    static LOGGING_SPAN_KEY = common_1.LOGGING_SPAN_KEY;
    static LOGGING_SAMPLED_KEY = common_1.LOGGING_SAMPLED_KEY;
    common;
    constructor(options) {
        options = options || {};
        super({
