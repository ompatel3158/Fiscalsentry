...
class Genkit extends import_ai.GenkitAI {
   ...
   */
  evaluate(params) {
    return (0, import_evaluator.evaluate)(this.registry, params);
  }
  /**
   * Reranks documents from a {@link RerankerArgument} based on the provided query.
   */
  rerank(params) {
    return (0, import_reranker.rerank)(this.registry, params);
  }
  /**
   ...
   */
  retrieve(params) {
    return (0, import_retriever.retrieve)(this.registry, params);
  }
  /**
...
function toModelRef(modelArg) {
  ...
  if (typeof modelArg === "string") {
    return (0, import_ai.modelRef)({ name: modelArg });
  }
  if (modelArg.name) {
    return modelArg;
  }
